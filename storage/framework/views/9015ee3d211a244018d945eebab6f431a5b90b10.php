    ...
    <div class="container-fluid">
        ...
        <div class="row py-5">
            ...
            <div class="card bar-chart">
                ...
                <div class="card-body">
                    <canvas id="yearlyReportChart"  data-sale_chart_value="<?php echo e(json_encode( $yearly_sale_amount)); ?>"
                    data-purchase_chart_value="<?php echo e(json_encode($yearly_purchase_amount)); ?>"  data-label1="Purchase Amount" data-label2="Sale Amount"></canvas>
                </div>
            </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoff/bestfood/resources/views/home.blade.php ENDPATH**/ ?>