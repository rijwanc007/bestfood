...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Username','name' => 'username','col' => 'col-md-4','placeholder' => 'Enter username']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Username','name' => 'username','col' => 'col-md-4','placeholder' => 'Enter username']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                        ...
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        <?php if(permission('sr-bulk-delete')): ?>
                                        <th>
...
<?php echo $__env->make('salesmen::modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function(){
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url      = "<?php echo e(route('sales.representative.store.or.update')); ?>";
    ...
    $(document).on('click', '.edit_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "<?php echo e(route('sales.representative.edit')); ?>",
                type: "POST",
                ...
                success: function (data) {
                    if(data.status == 'error'){
                        ...
                        if(data.avatar)
                        {
                            ...
                            $('#avatar .img_').attr('src',"<?php echo e(asset('storage/'.SALESMEN_AVATAR_PATH)); ?>/"+data.avatar);
                        }else{
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "<?php echo e(route('sales.representative.bulk.delete')); ?>";
...
function upazilaRouteList(upazila_id,salesmen_id='')
{
    if(upazila_id)
    {
        ...
        $.ajax({
            url:"<?php echo e(route('sales.representative.upazila.route.list')); ?>",
            type:"POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/demoff/bestfood/Modules/SalesMen/Resources/views/index.blade.php ENDPATH**/ ?>