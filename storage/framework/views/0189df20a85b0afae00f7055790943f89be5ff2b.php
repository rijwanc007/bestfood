    ...
    <div class="brand flex-column-auto " id="kt_brand">
        <div class="brand-logo">
            ...
            <a href="<?php echo e(url('dashboard')); ?>">
                <img src="<?php echo e(asset('storage/'.LOGO_PATH.config('settings.logo'))); ?>" style="max-width: 150px;" alt="Logo" />
            </a>
            <?php else: ?>
...
</div><?php /**PATH /home/demoff/bestfood/resources/views/components/sidebar.blade.php ENDPATH**/ ?>