...
class InventoryLedgerController extends BaseController
{
    ...
    public function index()
    {
        if(permission('inventory-ledger-access')){
            $this->setPageData('Inventory Ledger','Inventory Ledger','far fa-money-bill-alt',[['name'=>'Accounts','link'=>'javascript::void(0);'],['name'=>'Report','link'=>'javascript::void(0);'],['name'=>'Inventory Ledger']]);
