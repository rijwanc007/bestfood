          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.selectbox labelName="Name" name="employee_id" onchange="getLoanDetails(this.value)" required="required" col="col-md-12" class="selectpicker">
                    ...
                    <x-form.selectbox labelName="Loans" name="loan_id" required="required"  col="col-md-12" class="selectpicker"/>
                    <div class="form-group col-md-12">
                            <label for="date">Date</label>
                            <input type="text" class="form-control date" value="{{date('Y-m-d')}}" name="installment_date" id="installment_date" readonly/>
                    </div>
                    <x-form.textbox labelName="Installment Amount" name="installment_amount" required="required" col="col-md-12" placeholder="Enter Amount"/>
