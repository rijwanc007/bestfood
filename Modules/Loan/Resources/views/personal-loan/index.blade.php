...
@include('loan::personal-loan.modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('personal.loan.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                @if (permission('personal-loan-report'))
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('personal.loan.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #adjust_date').val(data.adjusted_date);
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('personal.loan.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('personal.loan.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('personal.loan.change.status') }}";
