...
@include('loan::official-loan.modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('official.loan.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "columnDefs": [{
                ...
                {
                    @if (permission('official-loan-bulk-delete'))
                    "targets": [1,3,5,7,9,10,11],
                    @else 
                    "targets": [0,2,4,6,8,9,10],
                    @endif
                    "className": "text-center"
                }
            ],
            ...
            "buttons": [
                @if (permission('official-loan-report'))
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('official.loan.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #voucher_no').val(data.voucher_no);
                            ...
                            $('#store_or_update_form #adjusted_date').val(data.adjusted_date);
                            $('#store_or_update_form #amount').val(data.amount);
                            $('#store_or_update_form #adjust_amount').val(data.adjust_amount);
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('official.loan.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('official.loan.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('official.loan.change.status') }}";
        ...
        $(document).on('click', '.approve_voucher', function () {
            ...
            let status = $(this).data('status');
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('official.loan.approve') }}";
            Swal.fire({
