...
class DepartmentController extends BaseController
{
    ...
    public function index()
    {
        if(permission('department-access')){
            $this->setPageData('Department','Department','fas fa-warehouse',[['name'=>'HRM','link'=>'javascript::void();'],['name' => 'Department']]);
            $deletable = self::DELETABLE;
            return view('hrm::department.index',compact('deletable'));
        }else{
