...
use Modules\HRM\Http\Requests\RouteFormRequest;

class RouteController extends BaseController
{
    public function __construct(EmployeeRoute $model)
    {
        $this->model = $model;
    }    
    ...
    public function index()
    {
        if(permission('route-access')){
            $this->setPageData('Route','Route','fas fa-warehouse',[['name'=>'HRM','link'=>'javascript::void();'],['name' => 'Route']]);
            $deletable = self::DELETABLE;
            return view('hrm::route.index',compact('deletable'));
        }else{
