...
use Modules\HRM\Http\Requests\DesignationFormRequest;
...
class DesignationController extends BaseController
{
    ...
    public function index()
    {
        if(permission('designation-access')){
            $this->setPageData('Designation','Designation','fas fa-warehouse',[['name'=>'HRM','link'=>'javascript::void();'],['name' => 'Designation']]);
            $deletable = self::DELETABLE;
            return view('hrm::designation.index',compact('deletable'));
        }else{
