...
class Attendance extends BaseModel
{
    ...
    protected $fillable = ['employee_id ','employee_route_id ','wallet_number','date_time','date', 'time', 'am_pm', 'time_str', 'time_str_am_pm', 'status','deletable ', 'created_by', 'modified_by'];
