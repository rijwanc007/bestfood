                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr class="bg-primary">
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th style="text-align: right !important;font-weight:bold;">Total Due Amount</th>
                                        <th style="text-align: right !important;font-weight:bold;" id="total_due"></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            const due_data = table.ajax.json();

            // // Update footer
            $(api.column(7).footer()).html('= '+number_format(due_data.total_due)+' Tk');
        }
    });
