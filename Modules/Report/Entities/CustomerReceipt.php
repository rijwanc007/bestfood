...
class CustomerReceipt extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['transaction.id','transactions.voucher_date','c.customer_id','c.district_id','c.upazila_id','c.route_id','c.area_id','transactions.description', 'transactions.credit',null];
        ...
        if (!empty($this->_from_date) && !empty($this->_to_date)) {
            $query->whereDate('transactions.voucher_date', '>=',$this->_from_date)
                ->whereDate('transactions.voucher_date', '<=',$this->_to_date);
        }
