                ...
                <div class="row">
                    <div class="col-md-2 mb-5">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a style="padding:10px;" class="nav-link active" id="v-pills-general-tab" data-toggle="pill" href="#v-pills-general" role="tab" aria-controls="v-pills-general" aria-selected="true">
                            <i class="far fa-id-badge mr-2"></i> Update Profile
                        </a>
                        <a style="padding:10px;" class="nav-link" id="v-pills-mail-tab" data-toggle="pill" href="#v-pills-mail" role="tab" aria-controls="v-pills-mail" aria-selected="false">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div style="margin: 0 auto;width:200px;">
                                            ...
                                            <input type="hidden" name="old_avatar" id="old_avatar" value="{{ Auth::guard('asm')->user()->avatar }}">
                                        </div>
                                        </div>
                                    </div>
...
$(document).ready(function(){
    ...
    $('#avatar .img_').attr('src',"{{ asset('storage/'.ASM_AVATAR_PATH.Auth::guard('asm')->user()->avatar)}}");
    @endif
});
...
function save_data(form_id) {
    ...
    let url;
    if(form_id == 'profile'){
        url = "{{route('asm.update.profile')}}";
    }else{
        url = "{{route('asm.update.password')}}"
    }
    $.ajax({
        url: url,
        type: "POST",
