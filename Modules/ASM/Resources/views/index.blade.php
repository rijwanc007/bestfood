        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showASMFormModal('Add New ASM','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
...
$(document).ready(function(){
                ...
                success: function (data) {
                    if(data.status == 'error'){
                        ...
                        if(data.avatar)
                        {
                            ...
                            $('#avatar .img_').attr('src',"{{ asset('storage/'.ASM_AVATAR_PATH)}}/"+data.avatar);
                        }else{
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let row    = table.row($(this).parent('tr'));
        let url    = "{{ route('asm.change.status') }}";
...
function showASMFormModal(modal_title, btn_text) {
    $('#store_or_update_form')[0].reset();
